...
import {profile as dbRegioProfile} from './index.js'

const client = createClient(dbRegioProfile, 'hafas-client-example')
...
// let data = await client.locations('südkreuz')
// let data = await client.stop(freiburgHbf)
