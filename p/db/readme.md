...
The default option is `HYBRID`. An explaination about different routing options can be found in [https://pastebin.com/qZ9WS3Cx](https://pastebin.com/qZ9WS3Cx). The option `HYBRID` also shows cancelled trains, in contrast to the default option `REALTIME`.
